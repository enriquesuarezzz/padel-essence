    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="flex flex-col pt-4">
          <div className="flex">
            ...
            <label htmlFor="checkbox">
              <OnestText
                text={dict.contact.form.checkbox}
                fontSize="16px"
                className=""
              />
            </label>
        ...
        <div className="mt-6 grid">
          <button
            type="submit"
            className="inline-flex w-fit items-center justify-center gap-x-2 rounded-lg border border-transparent bg-blue-600 px-4 py-3 text-sm font-semibold text-white disabled:opacity-50"
            disabled={isSending}
          >
